...
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot1.id, scheduled_time:  '8:00')

# Setting the same schedule for spot2
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot2.id, scheduled_time:  '8:00')

# Setting the same schedule for spot3
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot3.id, scheduled_time:  '8:00')


# Setting the same schedule for spot4
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot4.id, scheduled_time:  '8:00')



# Setting the same schedule for spot5
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot5.id, scheduled_time:  '8:00')



# Setting the same schedule for spot6
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot6.id, scheduled_time:  '8:00')



# Setting the same schedule for spot7
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot7.id, scheduled_time:  '8:00')



# Setting the same schedule for spot8
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot8.id, scheduled_time:  '8:00')



# Setting the same schedule for spot9
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot9.id, scheduled_time:  '8:00')



# Setting the same schedule for spot10
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,1,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,4,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,8,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,11,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,15,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,18,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,22,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,25,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,29,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,1,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,5,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,8,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,12,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,15,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,19,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,22,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,26,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,29,8,0,0), collection_type: 'C', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,6,8,0,0), collection_type: 'GCM', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,20,8,0,0), collection_type: 'GCM', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,3,8,0,0), collection_type: 'GCM', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,17,8,0,0), collection_type: 'GCM', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,7,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,14,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,21,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,28,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,4,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,11,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,18,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,25,8,0,0), collection_type: 'RP', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,3,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,10,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,17,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,24,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,5,31,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,7,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date:Time.new(2024,6,14,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,21,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
@spot_schedule = SpotDate.create!(date: Time.new(2024,6,28,8,0,0), collection_type: 'UPBBC', spot_id: spot10.id, scheduled_time:  '8:00')
